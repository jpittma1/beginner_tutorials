 ...
 *  Used TommyChangUMD's basic_test.cpp as a shell to resolve build errors.
 * https://github.com/TommyChangUMD/minimal-integration-test.git
 * @version 0.1
 * @date 2023-10-24
 *
...
/**
 * @brief Construct a new test fixture object; Test Subscriber
 *
 */
...
TEST_F(TestingFixture, test_pubcount) {
  ...
  PUBLISHER test_pub = node_->create_publisher<String>("chatter", 10);
  ...
  ASSERT_EQ(2, static_cast<int>(num_pub));
}
